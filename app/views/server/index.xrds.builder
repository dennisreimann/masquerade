...
xml.xrds(:XRDS,
  ...
  'xmlns' => 'xri://$xrd*($v*2.0)') do
    ...
    xml.Service(:priority => 1) do
      ...
      xml.Type OpenID::PAPE::AUTH_MULTI_FACTOR if Masquerade::Application::Config['use_ssl']
      xml.Type OpenID::PAPE::AUTH_PHISHING_RESISTANT if Masquerade::Application::Config['use_ssl']
